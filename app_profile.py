...
menu = st.sidebar.radio(
    "Go to:",
    ["Researcher Profile", "Projects", "Education", "Contact"],
)
...
if menu == "Researcher Profile":
    ...
    projects = [
        ...
        {"Title": "Web App GUI Design", "Technology": ".NET Web App, HTML, CSS, JavaScript"},
    ...
    st.title("Bachelor of Science in Information Technology")
    st.title("Now persuing")
    st.title("Bachelor of Science Hounors in Computer Science and Information Technology ")

elif menu == "Contact":
    st.header("Contact Information")
    email = "leemisamoleko@gmail.com"
    linkedin = "www.linkedin.com/in/leemisa-moleko-03480a297"
